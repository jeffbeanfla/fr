...
#   if flight.number == "DL188":
    ...
    ct=datetime.fromtimestamp (time_left)
    ...
    if f.destination_airport_iata == 'MIA' and operator.gt(distance,5): 
            print(f.number, f.origin_airport_iata,f.destination_airport_iata,distance, f.altitude,f.ground_speed,f.aircraft_model,time_left,minutes,ft)
